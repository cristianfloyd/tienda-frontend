...
import type { WordPressPost, WordPressCategory, WordPressUser } from '../../src/types/wordpress';
...
export const mockWordPressCategories: WordPressCategory[] = [
  {
    id: 1,
    count: 5,
...
export const mockWordPressUsers: WordPressUser[] = [
  {
    id: 1,
    name: 'Test User',
